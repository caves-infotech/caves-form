...
export default function NavBox1() {
  return (
    <div className="text-center justify-center items-center sm:mt-20 mt-10">
      ...
      <div className=" sm:m-20 sm:mx-[16%] m-12 grid grid-flow-row gap-12 text-gray-600 font-bold sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        >
          ...
          <h4 className="text-md">
            <b> Get your project approved</b> for BPMS online building
            permission with the guidance of our expert team!
          </h4>
        </div>
