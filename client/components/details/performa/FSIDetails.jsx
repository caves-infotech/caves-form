export default function FSIDetails({
  ...
  formData.fsi.area =
    parseFloat(formData.plot.proRata) > 0
        ...
        <div>
          ...
          <table className="table-auto w-[830px] mb-8 text-sm">
            <tbody>
              ...
              <tr className="even:bg-white  odd:bg-[#dededeac] ">
                <td className="border-x border-slate-400 px-4 py-2" colSpan="2">
                  2. Deductions for
                </td>
              </tr>
              <tr className="odd:bg-white  even:bg-[#dededeac] ">
                <td className="border-l border-slate-400 px-16 ">
              ...
              <tr className="odd:bg-white  even:bg-[#dededeac] ">
                <td className="border-l border-slate-400 px-16 pb-4">
                  c. Total (a + b):
                </td>
                <td
              ...
              <tr className="even:bg-white  odd:bg-[#dededeac] ">
                <td
                  className="border-x border-t border-slate-400 px-4 py-2"
                  colSpan="2"
                >
              ...
              <tr className="odd:bg-white  even:bg-[#dededeac] ">
                ...
                <td
                  className="border-r border-slate-400 px-4"
              ...
              <tr className="odd:bg-white  even:bg-[#dededeac] ">
                <td className="border px-4 border-slate-400 py-2">
                  14. Maximum utilization limit of FSI (building potential)
              ...
              <tr className="even:bg-white  odd:bg-[#dededeac] ">
                <td className="border-l border-b border-slate-400 px-16 pb-4">
                  b. Proposed:
                </td>
                <td className="border-r border-b border-slate-400 px-4 pb-4">
                  <input
                    type="number"
                    name="fsi.areOfInclusiveHousing.proposed"
                    value={formData.fsi.areOfInclusiveHousing.proposed}
