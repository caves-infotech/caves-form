      ...
      <table className="table-auto w-full mb-8 text-sm">
        <tbody>
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">1. Area (meter<sup>2</sup>):</td>
            <td
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-x border-slate-400 px-4 py-2" colSpan="2">2. Deductions for</td>
          </tr>
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16 ">a. Proposed D.P./D.P. Road widening Area/ Service Road/ Highway widening:</td>
            <td className="border-r border-slate-400 pl-2">
              <input
                type="number"
                name="fsi.deductions.proposedDp"
                value={formData.fsi.deductions.proposedDp}
                onChange={handleNestedChange}
                className="w-full p-2 border-2 border-slate-500 rounded"
              />
            </td>
          </tr>

          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">b. Any D.P. Reservation area:</td>
            <td className="border-r border-slate-400 px-4">
              <input
                type="number"
          ...
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16 pb-4">c. Total (a + b):</td>
            <td
              className="border-r border-slate-400 px-4 pb-4"
          ...
          <tr className="odd:bg-white  even:bg-yellow-100">
            <td className="border border-slate-400 px-4 py-2">3. Balance area of plot(1 - 2):</td>
            <td
              className="border border-slate-400 px-4 py-2"
          ...
          <tr className="odd:bg-white  even:bg-yellow-100">
            <td className="border-x border-slate-400 px-4 py-2" colSpan="2">4. Aminity Space</td>
          </tr>
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">a. Required:</td>
            <td className="border-r border-slate-400 px-4">
              <input
                type="number"
          ...
          <tr className="odd:bg-white  even:bg-yellow-100">
            <td className="border-l border-slate-400 px-16">b. Adjustment of 2(b), if any:</td>
            <td className="border-r border-slate-400 px-4">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16 pb-4">c. Balance Proposed:</td>
            <td className="border-r border-slate-400 px-4 pb-4">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">5. Net plot area (3 - 4(c)):</td>
            <td
              className="border border-slate-400 px-4 py-2"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-x border-slate-400 px-4 py-2" colSpan="2">6. Recreational Open Space</td>
          </tr>
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">a. Required:</td>
            <td className="border-r border-slate-400 px-4">
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16 pb-4">b. Proposed:</td>
            <td className="border-r border-slate-400 px-4 pb-4">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100">
            <td className="border border-slate-400 px-4 py-2">7. Internal Road Area:</td>
          ...
          <tr className="even:bg-white  odd:bg-yellow-100">
            <td className="border border-slate-400 px-4 py-2">8. Plotable Area:</td>
            <td className="border border-slate-400 px-4 py-2">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">9. Built up area with reference to basic FSI as per front road width:</td>
            <td
              className="border border-slate-400 px-4 py-2"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-x border-slate-400 px-4 py-2" colSpan="2">10. Addition of FSI on payment of premium:</td>
          </tr>
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">a. Maximum permissible premium FSI - based on road width/ TOD zone:</td>
            <td className="border-r border-slate-400 px-4">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16 pb-4">b. Proposed FSI on payment of premium:</td>
            <td className="border-r border-slate-400 px-4 pb-4">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-x border-slate-400 px-4 py-2" colSpan="2">11. In-situ FSI/ TDR loading:</td>
          </tr>
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">a. In-situ area against D.P. road [2.0 * 2(a)]:</td>
            <td className="border-r border-slate-400 px-4"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">b. In-situ area against aminity space if handed over:</td>
            <td className="border-r border-slate-400 px-4"
          ...
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">c. TDR area:</td>
            <td className="border-r border-slate-400 px-4">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16 pb-4">d. Total in-situ / TDR loading proposed (a + b + c):</td>
            <td className="border-r border-slate-400 px-4 pb-4"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">12. Additional FSI area under Chapter No.7:</td>
            <td className="border border-slate-400 px-4 py-2">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-x border-slate-400 px-4 py-2" colSpan="2">13. Total entitlement of FSI in the proposal:</td>
          </tr>
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">a. [9 + 10(b) + 11(d)] or 12 whichever is applicable:</td>
            <td className="border-r border-slate-400 px-4"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">b. Ancillary Area FSI up to 60% or 80% with payment of charges:</td>
            <td className="border-r border-slate-400 px-4">
              {/* <input
                type="number"
              ...
              <select
                ...
                value={formData.fsi.totalEntitlementProposed.ancillaryArea}
                onChange={handleNestedChange}
                className="w-full p-2 border-2 border-slate-500 rounded-lg bg-slate-100"
              >
          ...
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16 pb-4">c. Total entitlement(a + b):</td>
            <td className="border-r border-slate-400 px-4 pb-4"
          ...
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border px-4 border-slate-400 py-2">14. Maximum utilization limit of FSI (building potential) permissible as per-2 border-slate-500 road width:</td>
            <td
          ...
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-x border-slate-400 px-4 py-2" colSpan="2">15. Total built-up area in proposal (excluding area at 17(b)):</td>
          </tr>
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">a. Existing built-up area:</td>
            <td className="border-r border-slate-400 px-4">
              <input
                type="number"
          ...
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">b. Proposed built-up area as per P-line:</td>
            <td className="border-r border-slate-400 px-4">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">16. FSI consumed (15 / 13) OR {" < "} Sr.No. 14 :</td>
            <td
              className="border border-slate-400 px-4 py-2">
              <input
                type="number"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border-x border-slate-400 px-4 py-2" colSpan="2">17. Area for inclusive housing, if any:</td>
          </tr>
          <tr className="odd:bg-white  even:bg-yellow-100 ">
            <td className="border-l border-slate-400 px-16">a. Required(20% of Sr.No. 5):</td>
            <td className="border-r border-slate-400 px-4">
              <input
                type="number"
