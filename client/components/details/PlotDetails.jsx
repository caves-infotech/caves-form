      ...
      <table className="table-auto w-full text-sm">
        <tbody>
          <tr className="even:bg-white  odd:bg-yellow-100">
            <td className="border border-slate-400 px-4 py-2">1. Area Type:</td>
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">4. Plot type:</td>
            <td className="border border-slate-400 px-4 py-2 flex justify-around">
              <label className="flex items-center mb-2">
                <input
                  type="radio"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">5. Plot Area:</td>
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">6. Pro-Rata factor:</td>
            <td className="border border-slate-400 px-4 py-2">
              <input
                type="number"
                name="plot.proRata"
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">7. Built-up Area (meter<sup>2</sup>):</td>
            <td
          ...
          <tr className="even:bg-white  odd:bg-yellow-100 ">
            <td className="border border-slate-400 px-4 py-2">8. Road Width:</td>
            <td className="border border-slate-400 px-4 py-2">
              <select
                name="plot.roadWidth"
