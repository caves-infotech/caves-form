...
export default function Pdfsidebar({ setPage }) {
  ...
  return (
    <div>
      ...
      <div className=" sm:hidden flex">
        ...
        <div
          className={`fixed mt-12 left-0 top-0 w-[90%] h-full bg-white shadow-lg transform transition-transform duration-300 z-30 ${
