export default function ParkingDetails({
  ...
  if(formData.buildingType == "govOrPublicOrPrivate"){
    formData.govOrPublicOrPrivate.visitor.scooter = parseFloat(formData.govOrPublicOrPrivate.input) * 14.4;

    if(formData.areaType == "congested"){
      formData.govOrPublicOrPrivate.visitor.car = parseFloat(formData.govOrPublicOrPrivate.input) * 1.2;
    }else if(formData.areaType == "non-congested"){
      formData.govOrPublicOrPrivate.visitor.car = parseFloat(formData.govOrPublicOrPrivate.input) * 2.4;
    }
  }
            ...
            <table className="table-auto w-[530px] mb-8 text-sm">
              <tbody>
                ...
                <tr className="even:bg-white  odd:bg-[#dededeac] ">
                  ...
                  <td className="px-4 py-2 border border-slate-400" name="ulb">
                    <select
                      name="ulb"
                      value={formData.ulb}
                      onChange={handleChange}
                    ...
                    >
                      ...
                      <option value={0.8}>
                        Other Municipal Corporations in MMR area except Thane
                        M.C.
                      </option>
                      <option value={0.7}>
                        Remaining Municipal Corporations not covered at Sr. No.
                        1 to 3 and 5, Metropolitan Area Development Authority /
                        Area Development Authority/ SPA area
                      </option>
                      <option value={0.6}>
                      ...
                      <option value={0.4}>
                        Nagar Panchayat, Non Municipal Town Development Plan
