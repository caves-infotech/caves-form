const Topbar = ({ step, setStep }) => {
  return (
    ...
    <div className="pt-4 px-4 flex justify-between rounded-t-xl bg-white  border-b-2">
      ...
      <div className=" justify-end">
        <button
          className={`flex items-center rounded-xl text-white bg-black hover:bg-slate-600 transform transition-all duration-200 font-bold cursor-pointer mx-1 p-2 mb-2 `}
          onClick={() => setStep(4)}
        >
          <p className="pr-2">
            Preview
